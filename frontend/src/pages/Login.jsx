        ...
        <div className="w-screen lg:w-[48%] flex flex-col items-center justify-center">
          <div className="w-screen max-w-none sm:w-full sm:max-w-md min-h-screen sm:min-h-0 bg-white/90 dark:bg-slate-900/90 rounded-none sm:rounded-[30px] border-0 sm:border border-slate-200/80 dark:border-slate-700/80 p-5 sm:p-8 lg:p-9 shadow-[0_30px_80px_rgba(15,23,42,0.08)] dark:shadow-[0_30px_70px_rgba(2,6,23,0.45)] backdrop-blur-md flex flex-col justify-center mx-auto">
            ...
            <div className="space-y-2 text-center mb-5 sm:mb-7 shrink-0">
              <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-gray-900 dark:text-slate-100">تسجيل الدخول</h1>
              <p className="text-xs sm:text-sm text-gray-600 dark:text-slate-300 px-2 leading-6">ادخل إلى حسابك الآن لإدارة إعلاناتك ومحادثاتك.</p>
            ...
            <div className="custom-scrollbar pr-1 lg:overflow-y-auto lg:max-h-[500px]">
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-4 sm:mb-6">
                <button onClick={() => setActiveBox("phone")} className={`rounded-2xl border px-3 py-2.5 sm:px-4 sm:py-3 text-xs sm:text-sm font-bold text-center transition-all ${activeBox === "phone" ? "border-blue-500 bg-blue-50 text-blue-700 shadow-sm shadow-blue-100 dark:bg-blue-900/30 dark:text-blue-300" : "border-slate-200 bg-slate-50 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300"}`}>رقم الهاتف</button>
                <div className="relative group">
                  <button 
                    onClick={() => setActiveBox("email")} 
                    disabled={isEmailDisabled}
                    className={`w-full rounded-2xl border px-3 py-2.5 sm:px-4 sm:py-3 text-xs sm:text-sm font-bold text-center transition-all ${ 
