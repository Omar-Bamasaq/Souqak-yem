          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-6 lg:grid-cols-3 xl:grid-cols-4">
            {products.map((product, index) => (
              <React.Fragment key={product._id}>
                {/* Discovery banners - inserted after 10 and 20 products */}
                {index === 10 && (
                  <div className="col-span-2 mb-6 lg:col-span-3 xl:col-span-4">
                    <div className="flex flex-col items-center justify-between gap-5 rounded-3xl border border-white/10 bg-gradient-to-r from-emerald-600 to-teal-700 p-5 text-white shadow-xl shadow-emerald-500/20 sm:flex-row sm:p-6">
                      <div className="flex min-w-0 items-center gap-4">
                        ...
                        <div className="min-w-0">
                          <h3 className="mb-1 text-lg font-black sm:text-xl">كن سفيرًا لسوقك واربح من دعواتك</h3>
                          <p className="text-sm font-medium text-emerald-100">شارك رابطك الخاص واحصل على 10% من العمولات والرسوم المؤهلة</p>
                        </div>
                      </div>
                      <Link to="/referrals" className="w-full shrink-0 rounded-xl bg-white px-6 py-3 text-center font-black text-emerald-700 shadow-lg transition-all hover:scale-[1.02] active:scale-95 sm:w-auto">
                        اكتشف سفراء سوقك
                      </Link>
                    </div>
                  </div>
                ...
                {index === 20 && (
                  <div className="col-span-2 mb-6 lg:col-span-3 xl:col-span-4">
                    <div className="flex flex-col items-center justify-between gap-5 rounded-3xl border border-white/10 bg-gradient-to-r from-blue-600 to-indigo-700 p-5 text-white shadow-xl shadow-blue-500/20 sm:flex-row sm:p-6">
                      <div className="flex min-w-0 items-center gap-4">
                        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-white/20">
                          <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="min-w-0">
                          <h3 className="mb-1 text-lg font-black sm:text-xl">وجدت منتجًا خارج سوقك؟ اشتره بأمان</h3>
                          <p className="text-sm font-medium text-blue-100">اطلب من البائع إضافته إلى سوقك وأكمل الصفقة مع حماية الشراء الآمن</p>
                        </div>
                      </div>
                      <Link to="/secure-deal-explanation" className="w-full shrink-0 rounded-xl bg-white px-6 py-3 text-center font-black text-blue-700 shadow-lg transition-all hover:scale-[1.02] active:scale-95 sm:w-auto">
                        تعرّف على الشراء الآمن
                      </Link>
                    </div>
                  </div>
                )}
