...
const HowItWorks = () => {
  ...
  const content = {
    ...
    reseller: {
      ...
      steps: [
        { title: 'اختر المنتجات', desc: 'ابحث عن الإعلانات التي تدعم ميزة "إعادة البيع" والعمولات الجذابة.', icon: '🎯' },
        { title: 'أعد النشر بنقرة', desc: 'انشر المنتج في حسابك الخاص أو عبر منصات التواصل برابطك الفريد.', icon: '🔗' },
        { title: 'بع وسوق', desc: 'تواصل مع زبائنك الخاصين وأتمم صفقاتك باسمك الخاص.', icon: '🤝' },
        { title: 'اربح عمولتك', desc: 'عند إتمام أي عملية بيع من خلالك، تضاف عمولتك تلقائياً لمحفظتك.', icon: '📈' },
      ],
      faq: [
        { q: 'هل أحتاج لامتلاك المنتج؟', a: 'لا، أنت تسوق لمنتجات الآخرين، والبائع الأصلي هو من يتكفل بالشحن.' },
        { q: 'كيف أعرف أرباحي؟', a: 'ستظهر لك تقارير مفصلة في لوحة التحكم الخاصة بك لكل عملية بيع ناجحة.' },
      ]
    }
  };
