...
SellerReportSchema.index({ createdAt: 1 });

SellerReportSchema.plugin(softDeletePlugin);

export default mongoose.models.SellerReport || mongoose.model("SellerReport", SellerReportSchema);
